...
View a live demo of `timevis` and its capabilities [here](http://daattali.com/shiny/timevis-demo/).
...
The content of an item can include HTML, which makes it easy to show any kind of data in a timeline, such as the matches of the 2014 World Cup:
...
By default, a timeline will show the current date as a red vertical line and will have zoom in/out buttons. You can move to future and past dates by clicking anywhere and dragging the mouse to the right or left. Of course the zooming and moving won't work on this image, but if you run `timevis()` in RStudio you will be able to interact with the timeline.
